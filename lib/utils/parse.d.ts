...
import type { _Uint64_bigint, _Uint64_num, FixlenHexString, HexString, NameString, ParsedActionAuthorisation, ParsedTransaction, Uint8_t, Uint16_t, Uint32_t, Uint64_str, ValidBIP32Path, VarlenAsciiString } from "../types/internal";
...
export declare const isBigIntLike: (data: unknown) => data is bigint_like;
...
export declare const MAX_NAME_STRING_LENGTH = 12;
export declare const isNameString: (data: unknown) => data is NameString;
...
export declare function parseContractAccountName(account: string, name: string, errMsg: InvalidDataReason): HexString;
export declare function parseNameString(name: string, errMsg: InvalidDataReason): NameString;
export declare function parseAuthorization(authorization: ActionAuthorisation, errMsg: InvalidDataReason): ParsedActionAuthorisation;
export declare function parseTransaction(chainId: string, tx: Transaction): ParsedTransaction;
